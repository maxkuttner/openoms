...
INSERT INTO instrument_universe
    (code, description, category, dataset, option_dataset, stype_in, include_options)
VALUES
    ...
    ('XBOS_ITCH',      'Nasdaq BX (TotalView-ITCH)',            'EQUITY', 'XBOS.ITCH',      NULL, 'raw_symbol', false),
    ...
    ('XASE_PILLAR',    'NYSE American (Pillar)',                'EQUITY', 'XASE.PILLAR',    NULL, 'raw_symbol', false),
    ('XCHI_PILLAR',    'NYSE Chicago (Pillar)',                 'EQUITY', 'XCHI.PILLAR',    NULL, 'raw_symbol', false),
    ('XCIS_TRADESBBO', 'NYSE National (Trades & BBO)',          'EQUITY', 'XCIS.TRADESBBO', NULL, 'raw_symbol', false),
    ...
    ('EQUS_SUMMARY',   'Databento US Equities Summary',         'EQUITY', 'EQUS.SUMMARY',   NULL, 'raw_symbol', false),
    -- Options
    ('OPRA_PILLAR',    'OPRA — all US options',                 'OPTION', 'OPRA.PILLAR',    NULL, 'raw_symbol', false),
    -- Futures
    ('GLBX_MDP3',      'CME Globex (MDP 3.0)',                  'FUTURE', 'GLBX.MDP3',      NULL, 'raw_symbol', false),
    ('IFEU_IMPACT',    'ICE Futures Europe (iMpact)',           'FUTURE', 'IFEU.IMPACT',    NULL, 'raw_symbol', false),
    ('NDEX_IMPACT',    'ICE Endex (iMpact)',                    'FUTURE', 'NDEX.IMPACT',    NULL, 'raw_symbol', false)
